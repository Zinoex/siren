...
def parse_arguments():
    ...
    parser.add_argument('--queue-weight', type=float, default=0.1, help='Set queue weight.')
    parser.add_argument('--stops-weight', type=float, default=1, help='Set stops weight.')
    parser.add_argument('--request-weight', type=float, default=0.1, help='Set wait weight (should be small).')
    parser.add_argument('--green-weight', type=float, default=0.05, help='Set green weight (should be small).')
    parser.add_argument('--throughput-weight', type=float, default=2, help='Set throughput weight.')
    parser.add_argument('--discount-factor', type=float, default=0.85, help='Set discount factor for all objectives')
